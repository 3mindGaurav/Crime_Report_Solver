                ...
                <td colspan="2" align="center">
                    ...
                    <form method="post" action="individualcomplain.php" enctype="multipart/form-data">
                        <table cellpadding="10" cellspacing="0" border="0" width="90%" bgcolor="lightyellow">
                            <tr bgcolor="red" size="4">    <td colspan="4" align="center"><font color="white" size="4">INDIVIDUAL COMPLAIN FEEDING</font></td>    </tr>
                                    <tr>    <td width="25%"></td><td>Complainant Id Type</td><td>
                                
                                            <select name="cmb_id">
                                                <option value="" selected>-select id type-</option>
                                                <option value="PAN">Personal Account Num.</option>
                                                <option value="AdharCard">AdharCardNo.</option>
